...
Public Class AppBase
    ...
    Private fChangeHistories As XPCollection(Of AuditDataItemPersistent)
    Public ReadOnly Property ChangeHistories() As XPCollection(Of AuditDataItemPersistent)
        Get
            If fChangeHistories Is Nothing Then
                fChangeHistories = AuditedObjectWeakReference.GetAuditTrail(Session, Me)
            End If
            Return fChangeHistories
        End Get
    End Property
