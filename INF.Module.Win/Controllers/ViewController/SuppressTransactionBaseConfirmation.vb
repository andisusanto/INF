...
Public Class SuppressTransactionBaseConfirmation
    ...
    Protected Overrides Sub OnActivated()
        ...
        If IsDescendant(Of TransactionBase)(View.ObjectTypeInfo.Type) Then
            SubmitAction = Frame.GetController(Of INF.Module.TransactionBaseController)().MySubmitAction
            CancelSubmitAction = Frame.GetController(Of INF.Module.TransactionBaseController).MyCancelAction
        End If
    End Sub
