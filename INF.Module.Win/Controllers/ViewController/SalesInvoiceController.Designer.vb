Partial Class SalesInvoiceController
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnWizardFromSalesOrder.Id = "btnWizardSalesInvoiceFromSalesOrder"
        ...
        Me.btnWizardFromSalesOrder.TargetObjectsCriteria = "EnableWizard = TRUE"
        Me.btnWizardFromSalesOrder.TargetObjectType = GetType(INF.[Module].SalesInvoice)
        ...
        Me.btnWizardFromSalesOrder.ToolTip = "Create details from Sales Order"
        Me.btnWizardFromSalesOrder.TypeOfView = GetType(DevExpress.ExpressApp.DetailView)
        '
        'SalesInvoiceController
        '
        Me.TargetObjectType = GetType(INF.[Module].SalesInvoice)
